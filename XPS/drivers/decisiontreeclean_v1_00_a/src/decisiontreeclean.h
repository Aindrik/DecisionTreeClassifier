/*****************************************************************************
* Filename:          C:\research\DecisionTreeClean\XPS/drivers/decisiontreeclean_v1_00_a/src/decisiontreeclean.h
* Version:           1.00.a
* Description:       decisiontreeclean Driver Header File
...
/**
 *
 * Write a value to a DECISIONTREECLEAN register. A 32 bit write is performed.
 * If the component is implemented in a smaller width, only the least
 * significant data is written.
 *
 * @param   BaseAddress is the base address of the DECISIONTREECLEAN device.
...
/**
 *
 * Read a value from a DECISIONTREECLEAN register. A 32 bit read is performed.
 * If the component is implemented in a smaller width, only the least
...
/**
 *
 * Write/Read 32 bit value to/from DECISIONTREECLEAN user logic slave registers.
 *
 * @param   BaseAddress is the base address of the DECISIONTREECLEAN device.
...
/**
 *
 * Write/Read 32 bit value to/from DECISIONTREECLEAN user logic memory (BRAM).
 *
 * @param   Address is the memory address of the DECISIONTREECLEAN device.
