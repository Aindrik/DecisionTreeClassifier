/*****************************************************************************
* Filename:          C:\research\DecisionTreeClean\XPS/drivers/decisiontreeclean_v1_00_a/src/decisiontreeclean_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the decisiontreeclean driver
 ...
 *
 * @param   baseaddr_p is the base address of the DECISIONTREECLEAN instance to be worked on.
 *
 * @return
 *
 ...
 *
 */
XStatus DECISIONTREECLEAN_SelfTest(void * baseaddr_p)
{
  int     Index;
  Xuint32 baseaddr;
  Xuint8  Reg8Value;
  ...
  DECISIONTREECLEAN_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = DECISIONTREECLEAN_mReadSlaveReg0(baseaddr, 0);
  ...
  DECISIONTREECLEAN_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = DECISIONTREECLEAN_mReadSlaveReg1(baseaddr, 0);
  ...
  DECISIONTREECLEAN_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = DECISIONTREECLEAN_mReadSlaveReg2(baseaddr, 0);
  ...
  DECISIONTREECLEAN_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = DECISIONTREECLEAN_mReadSlaveReg3(baseaddr, 0);
  ...
  DECISIONTREECLEAN_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = DECISIONTREECLEAN_mReadSlaveReg4(baseaddr, 0);
  ...
  DECISIONTREECLEAN_mWriteSlaveReg5(baseaddr, 0, 6);
  Reg32Value = DECISIONTREECLEAN_mReadSlaveReg5(baseaddr, 0);
  ...
  DECISIONTREECLEAN_mWriteSlaveReg6(baseaddr, 0, 7);
  Reg32Value = DECISIONTREECLEAN_mReadSlaveReg6(baseaddr, 0);
  ...
  DECISIONTREECLEAN_mWriteSlaveReg7(baseaddr, 0, 8);
  Reg32Value = DECISIONTREECLEAN_mReadSlaveReg7(baseaddr, 0);
  ...
  {
    DECISIONTREECLEAN_mWriteMemory(LocalBRAM+4*Index, 0xDEADBEEF);
    Mem32Value = DECISIONTREECLEAN_mReadMemory(LocalBRAM+4*Index);
  ...
  Reg32Value = DECISIONTREECLEAN_mReadReg(baseaddr, DECISIONTREECLEAN_INTR_IPISR_OFFSET);
  xil_printf("   - IP (user logic) interrupt status : 0x%08x\n\r", Reg32Value);
  xil_printf("   - clear IP (user logic) interrupt status register\n\r");
  DECISIONTREECLEAN_mWriteReg(baseaddr, DECISIONTREECLEAN_INTR_IPISR_OFFSET, Reg32Value);
  xil_printf("   - enable all possible interrupt(s)\n\r");
  DECISIONTREECLEAN_EnableInterrupt(baseaddr_p);
