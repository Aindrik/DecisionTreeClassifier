------------------------------------------------------------------------------
-- decisiontreeclean.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          decisiontreeclean.vhd
-- Version:           1.00.a
...
use decisiontreeclean_v1_00_a.user_logic;
...
end entity decisiontreeclean;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of decisiontreeclean is
  ...
  constant IPIF_ARD_NUM_CE_ARRAY          : INTEGER_ARRAY_TYPE   := 
    (
      ...
      4  => 1                             -- number of ce for user logic memory space 2 (always 1 chip enable)
    );
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity decisiontreeclean_v1_00_a.user_logic
    generic map
    (
  ...
  begin
    ...
    case ipif_Bus2IP_CS is
      ...
      when "01000" => ipif_IP2Bus_Data <= intr_IP2Bus_Data;
